...
namespace API
{
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
                ...
                c.SwaggerDoc(
                    ...
                    new OpenApiInfo
                    {
                        ...
                        Contact = new OpenApiContact()
                        {
                            ...
                            Url = new System.Uri("https://www.SMA.edu.pe/"),
                            Email = "SMA@SMA.edu.pe",
                        },
                        Description = AppSettingsProvider.config.ApplicationDescription,

                        License = new OpenApiLicense() { Name = AppSettingsProvider.config.OrganizationName, Url = new System.Uri("https://www.SMA.edu.pe/") },
                        TermsOfService = new System.Uri("https://www.SMA.edu.pe/")
                    });
            ...
            services.AddTransient<IPlanProyectoRepository, PlanProyectoRepository>();
